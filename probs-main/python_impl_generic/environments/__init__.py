...
from . import togyzkumalak_env
from . import togyzkumalak_nn
...
def get_create_env_func(env_name: str):
    ...
    if env_name == "togyzkumalak": return togyzkumalak_env.create_env_func
...
def create_model(env_name: str, model_class_name: str):
    ...
    if env_name.startswith("togyzkumalak"):
        return getattr(togyzkumalak_nn, model_class_name)()
